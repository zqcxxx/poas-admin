      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button
            ...
            type="success"
            round
            @click="handleEdit(scope.row)">查看问卷结果</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { getPublishSurvey, getSurveys, getSurveyCount, publishSurvey, delSurvey, getSurvey } from '@/api/survey'
import { formatDate } from '@/utils/date'
  export default {
    ...
    methods: {
      ...
      handleEdit(row) {
        let sid = row.id
        this.$router.push(`/showresult/${sid}`)
      },
